...
var stream_urls         = { user: 'https://userstream.twitter.com/1.1/user.json'
...
function Stream(params) {
    ...
    params.stream_type = params.stream_type || 'user';
    params.stream_url = stream_urls[params.stream_type];
